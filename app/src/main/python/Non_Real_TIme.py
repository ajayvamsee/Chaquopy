...
##########################
#Global Variables
input_path = r'C:\Work\Techolution\Android\DTLN\input'
output_path = r'C:\Work\Techolution\Android\DTLN\output'
##########################
...
# write to .wav file
print("####################################### ", wav_file)
sf.write(os.path.join(output_path, wav_file), out_file, fs)
